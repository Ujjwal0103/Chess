...
===============================
- Include a screenshot of your project's file structure. =:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=
                                                         CIS 1200 Game Project README
                                                         PennKey: 18720296
                                                         =:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=:=
                                                         ...
                                                         I think there is good separation of functionality, but I would say my private
                                                         state is not that well encapsulated, a lot of things are public and have been
                                                         accessed by the dot notation in place of getters and setters. One thing I
                                                         guess I would do is make my validations more robust and crisp, right now I think
                                                         there is a much better way of writing them.
