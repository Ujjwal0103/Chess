...
public class Board extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private static final String RESOURCES_WBISHOP_PNG = "white-bishop" +
            ".png";
    private static final String RESOURCES_BBISHOP_PNG = "black-bishop" +
            ".png";
    private static final String RESOURCES_WKNIGHT_PNG = "white-knight" +
            ".png";
    private static final String RESOURCES_BKNIGHT_PNG = "black-knight" +
            ".png";
    private static final String RESOURCES_WROOK_PNG = "white-rook.png";
    private static final String RESOURCES_BROOK_PNG = "black-rook.png";
    private static final String RESOURCES_WKING_PNG = "white-king.png";
    private static final String RESOURCES_BKING_PNG = "black-king.png";
    private static final String RESOURCES_BQUEEN_PNG = "black-queen.png";
    private static final String RESOURCES_WQUEEN_PNG = "white-queen.png";
    private static final String RESOURCES_WPAWN_PNG = "white-pawn.png";
    private static final String RESOURCES_BPAWN_PNG = "black-pawn.png";
